...
static void parseExe(const char *exefname, uint8 *exe, uint32 exelen)
{
    ...
    printf("module version: %u\n", (unsigned int) lx->module_version);
    ...
    printf("Number of pages in module: %u\n", (unsigned int) lx->module_num_pages);
    printf("EIP Object number: %u\n", (unsigned int) lx->eip_object);
    printf("EIP: 0x%X\n", (unsigned int) lx->eip);
    printf("ESP Object number: %u\n", (unsigned int) lx->esp_object);
    printf("ESP: 0x%X\n", (unsigned int) lx->esp);
    printf("Page size: %u\n", (unsigned int) lx->page_size);
    printf("Page offset shift: %u\n", (unsigned int) lx->page_offset_shift);
    printf("Fixup section size: %u\n", (unsigned int) lx->fixup_section_size);
    printf("Fixup section checksum: 0x%X\n", (unsigned int) lx->fixup_section_checksum);
    printf("Loader section size: %u\n", (unsigned int) lx->loader_section_size);
    printf("Loader section checksum: 0x%X\n", (unsigned int) lx->loader_section_checksum);
    printf("Object table offset: %u\n", (unsigned int) lx->object_table_offset);
    printf("Number of objects in module: %u\n", (unsigned int) lx->module_num_objects);
    printf("Object page table offset: %u\n", (unsigned int) lx->object_page_table_offset);
    printf("Object iterated pages offset: %u\n", (unsigned int) lx->object_iter_pages_offset);
    printf("Resource table offset: %u\n", (unsigned int) lx->resource_table_offset);
    printf("Number of resource table entries: %u\n", (unsigned int) lx->num_resource_table_entries);
    printf("Resident name table offset: %u\n", (unsigned int) lx->resident_name_table_offset);
    printf("Entry table offset: %u\n", (unsigned int) lx->entry_table_offset);
    printf("Module directives offset: %u\n", (unsigned int) lx->module_directives_offset);
    printf("Number of module directives: %u\n", (unsigned int) lx->num_module_directives);
    printf("Fixup page table offset: %u\n", (unsigned int) lx->fixup_page_table_offset);
    printf("Fixup record table offset: %u\n", (unsigned int) lx->fixup_record_table_offset);
    printf("Import module table offset: %u\n", (unsigned int) lx->import_module_table_offset);
    printf("Number of inport module entries: %u\n", (unsigned int) lx->num_import_mod_entries);
    printf("Import procedure name table offset: %u\n", (unsigned int) lx->import_proc_table_offset);
    printf("Per-page checksum offset: %u\n", (unsigned int) lx->per_page_checksum_offset);
    printf("Data pages offset: %u\n", (unsigned int) lx->data_pages_offset);
    printf("Number of preload pages: %u\n", (unsigned int) lx->num_preload_pages);
    printf("Non-resident name table offset: %u\n", (unsigned int) lx->non_resident_name_table_offset);
    printf("Non-resident name table length: %u\n", (unsigned int) lx->non_resident_name_table_len);
    printf("Non-resident name table checksum: 0x%X\n", (unsigned int) lx->non_resident_name_table_checksum);
    printf("Auto data segment object number: %u\n", (unsigned int) lx->auto_ds_object_num);
    printf("Debug info offset: %u\n", (unsigned int) lx->debug_info_offset);
    printf("Debug info length: %u\n", (unsigned int) lx->debug_info_len);
    printf("Number of instance pages in preload section: %u\n", (unsigned int) lx->num_instance_preload);
    printf("Number of instance pages in demand section: %u\n", (unsigned int) lx->num_instance_demand);
    printf("Heap size: %u\n", (unsigned int) lx->heapsize);
    ...
    for (uint32 i = 0; i < lx->module_num_objects; i++) {
        ...
        printf("Object #%u:\n", (unsigned int) i+1);
        printf("Virtual size: %u\n", (unsigned int) obj->virtual_size);
        printf("Relocation base address: 0x%X\n", (unsigned int) obj->reloc_base_addr);
        printf("Object flags:");
        ...
        printf("\n");
        printf("Page table index: %u\n", (unsigned int) obj->page_table_index);
        printf("Number of page table entries: %u\n", (unsigned int) obj->num_page_table_entries);
        printf("System-reserved field: %u\n", (unsigned int) obj->reserved);
        ...
        for (uint32 i = 0; i < obj->num_page_table_entries; i++, objpage++) {
            ...
            printf("Page flags: (%u)", (unsigned int) objpage->flags);
    ...
    for (uint32 i = 0; i < lx->num_resource_table_entries; i++) {
        ...
        printf("%u:\n", (unsigned int) i);
        printf("Type ID: %u\n", (unsigned int) rsrc->type_id);
        printf("Name ID: %u\n", (unsigned int) rsrc->name_id);
        printf("Resource size: %u\n", (unsigned int) rsrc->resource_size);
        printf("Object: %u\n", (unsigned int) rsrc->object);
        printf("Offset: 0x%X\n", (unsigned int) rsrc->offset);
        printf("\n");
    } // for
    ...
    while (*entryptr) {  /* end field has a value of zero. */
        ...
        printf("Bundle %d (%u entries): ", bundleid, (unsigned int) numentries);
        bundleid++;
        ...
        switch (bundletype) {
            ...
            case 0x01:
                ...
                for (uint8 i = 0; i < numentries; i++) {
                    ...
                    printf("\n");
                    printf(" Parameter word count: %u\n",  (unsigned int) ((*entryptr & 0xF8) >> 3)); entryptr++;
                    printf(" Offset: %u\n",  (unsigned int) *((const uint16 *) entryptr)); entryptr += 2;
                    printf("\n");
                }
                break;
            ...
            case 0x03: printf("32BIT\n");
                ...
                for (uint8 i = 0; i < numentries; i++) {
                    ...
                    printf("\n");
                    printf(" Parameter word count: %u\n",  (unsigned int) ((*entryptr & 0xF8) >> 3)); entryptr++;
                    printf(" Offset: %u\n",  (unsigned int) *((const uint32 *) entryptr)); entryptr += 4;
                    printf("\n");
                }
                break;
