...
enum
{
    ...
    ERROR_SEM_BUSY = 301,
    ERROR_USER_DEFINED_BASE = 0xFF00,
    ...
    ALLOWED_ACKNOWLEDGE = 0x0010,
    ALLOWED_DISPATCH = 0x8000,
    ALLOWED_REGDUMP = 0x0020,
    ALLOWED_DETACHED = ALLOWED_DISPATCH,
    ALLOWED_RESERVED = ~(ALLOWED_FAIL|ALLOWED_ABORT|ALLOWED_RETRY|ALLOWED_IGNORE|ALLOWED_ACKNOWLEDGE),
    I24_OPERATION = 0x01,
    I24_AREA = 0x06,
    I24_CLASS = 0x80,
    ERRCLASS_OUTRES = 1,
